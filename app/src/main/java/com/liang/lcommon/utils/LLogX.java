...
public final class LLogX {
    ...
    public static LLogX.Config getConfig() {
        return CONFIG;
    }
    ...
    public static void file(@LLogX.TYPE final int type, final Object content) {
    ...
    public static void file(@LLogX.TYPE final int type, final String tag, final Object content) {
    ...
    public static void json(@LLogX.TYPE final int type, final String content) {
    ...
    public static void json(@LLogX.TYPE final int type, final String tag, final String content) {
    ...
    public static void xml(@LLogX.TYPE final int type, final String content) {
    ...
    public static void xml(@LLogX.TYPE final int type, final String tag, final String content) {
    ...
    public static void log(final int type, final String tag, final Object... contents) {
        ...
        final LLogX.TagHead tagHead = processTagAndHead(tag);
    ...
    private static LLogX.TagHead processTagAndHead(String tag) {
        if (!CONFIG.mTagIsSpace && !CONFIG.mLogHeadSwitch) {
            ...
            if (stackIndex >= stackTrace.length) {
                ...
                return new LLogX.TagHead(tag, null, ": ");
            }
            ...
            if (CONFIG.mLogHeadSwitch) {
                ...
                if (CONFIG.mStackDeep <= 1) {
                    return new LLogX.TagHead(tag, new String[]{head}, fileHead);
                } else {
                    ...
                    return new LLogX.TagHead(tag, consoleHead, fileHead);
                }
            }
        }
        return new LLogX.TagHead(tag, null, ": ");
    ...
    private static void print2File(final int type, final String tag, final String msg) {
        ...
        if (!createOrExistsFile(fullPath)) {
            Log.e("LLogX", "create " + fullPath + " failed!");
            return;
        }
        StringBuilder sb = new StringBuilder();
        sb.append(time)
    ...
    private static void input2File(final String input, final String filePath) {
        ...
        Log.e("LLogX", "log to " + filePath + " failed!");
    }
    ...
    public static class Config {
        ...
        public LLogX.Config setLogSwitch(final boolean logSwitch) {
            mLogSwitch = logSwitch;
            return this;
        }

        public LLogX.Config setConsoleSwitch(final boolean consoleSwitch) {
            mLog2ConsoleSwitch = consoleSwitch;
            return this;
        }

        public LLogX.Config setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                mGlobalTag = "";
                mTagIsSpace = true;
            } else {
        ...
        public LLogX.Config setLogHeadSwitch(final boolean logHeadSwitch) {
            mLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public LLogX.Config setLog2FileSwitch(final boolean log2FileSwitch) {
            mLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public LLogX.Config setDir(final String dir) {
            if (isSpace(dir)) {
                mDir = null;
            } else {
        ...
        public LLogX.Config setDir(final File dir) {
            mDir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public LLogX.Config setFilePrefix(final String filePrefix) {
        ...
        public LLogX.Config setBorderSwitch(final boolean borderSwitch) {
            mLogBorderSwitch = borderSwitch;
            return this;
        }

        public LLogX.Config setSingleTagSwitch(final boolean singleTagSwitch) {
            mSingleTagSwitch = singleTagSwitch;
            return this;
        }

        public LLogX.Config setConsoleFilter(@LLogX.TYPE final int consoleFilter) {
            mConsoleFilter = consoleFilter;
            return this;
        }

        public LLogX.Config setFileFilter(@LLogX.TYPE final int fileFilter) {
            mFileFilter = fileFilter;
            return this;
        }

        public LLogX.Config setStackDeep(@IntRange(from = 1) final int stackDeep) {
            mStackDeep = stackDeep;
            return this;
        }

        public LLogX.Config setStackOffset(@IntRange(from = 0) final int stackOffset) {
