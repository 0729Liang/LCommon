...
public class LActivityAnimX {
    ...
    public static class ActivityAnimConfig {
        public static int ACT_ANIM_NULL                = R.anim.act_no_anim;
        public static int ACT_ANIM_FADE_IN             = R.anim.act_fade_in;
        public static int ACT_ANIM_FADE_OUT            = R.anim.act_fade_out;
        public static int ACT_ANIM_LEFT_IN             = R.anim.act_translate_left_in;
        public static int ACT_ANIM_LEFT_OUT            = R.anim.act_translate_left_out;
        public static int ACT_ANIM_RIGHT_IN            = R.anim.act_translate_right_in;
        public static int ACT_ANIM_RIGHT_OUT           = R.anim.act_translate_right_out;
        public static int ACT_ANIM_TOP_IN              = R.anim.act_translate_top_in;
        public static int ACT_ANIM_TOP_OUT             = R.anim.act_translate_top_out;
        public static int ACT_ANIM_BOTTOM_IN           = R.anim.act_translate_bottom_in;
        public static int ACT_ANIM_BOTTOM_OUT          = R.anim.act_translate_bottom_out;
        public static int ACT_ANIM_SCALE_IN            = R.anim.act_scale_in;
        public static int ACT_ANIM_SCALE_OUT           = R.anim.act_scale_out;
        public static int ACT_ANIM_ROTATE_POSITIVE_IN  = R.anim.act_positive_rotate_in;
        public static int ACT_ANIM_ROTATE_POSITIVE_OUT = R.anim.act_positive_rotate_out;
        public static int ACT_ANIM_ROTATE_REVERSE_IN   = R.anim.act_reverse_rotate_in;
        public static int ACT_ANIM_ROTATE_REVERSE_OUT  = R.anim.act_reverse_rotate_out;
    }
