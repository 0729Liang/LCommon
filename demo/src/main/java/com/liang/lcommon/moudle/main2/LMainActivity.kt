package com.liang.lcommon.moudle.main2
...
import com.liang.lcommon.moudle.main2.fragment.BlogFragment
import com.liang.lcommon.moudle.main2.fragment.UtilsFragment
import com.liang.lcommon.moudle.main2.fragment.ViewFragment
import com.liang.lcommon.moudle.main2.viewpager.LFragmentPagerAdapter
...
class LMainActivity : AppCompatActivity() {
    ...
    fun dataFactory() {
        ...
        // LineChartDemo
        addItem(LineChartDemo.newItem())

        //
        addItem(PopupWindowDemo.newItem())
    }
