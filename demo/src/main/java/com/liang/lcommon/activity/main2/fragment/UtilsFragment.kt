...
class UtilsFragment : LBaseFragment() {

    private val mList = ArrayList<LBaseItemBean>()  // 数据源
    private var mAdapter :LBaseAdapter = LBaseAdapter(mList) // 适配器
    private lateinit var mRecyclerView: RecyclerView
    //private var mAdapterReference:WeakReference<LBaseAdapter> = WeakReference( LBaseAdapter(mList))//
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(name: String) = UtilsFragment().apply { mName = name }
